...
Revision ID: a8d97a86c0fd
Revises: 
Create Date: 2020-10-20 19:49:22.506936
...
def upgrade():
    ...
    op.create_index(op.f('ix_posts_user_id'), 'posts',
    ...
    op.create_index(op.f('ix_comments_post_id'),
                    'comments', ['post_id'], unique=False)
    op.create_index(op.f('ix_comments_user_id'),
                    'comments', ['user_id'], unique=False)
