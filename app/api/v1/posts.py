...
v1.add_url_rule('/posts/', defaults = {'post_id':None}, view_func =  post_view, methods = ['GET'])
v1.add_url_rule('/posts/', view_func =  post_view, methods = ['POST'])
v1.add_url_rule('/posts/<int:post_id>', view_func =  post_view, methods = ['GET','PUT','DELETE','PATCH'])
