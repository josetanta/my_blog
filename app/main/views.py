...
def home():
	...
	page = request.args.get('page',1, type=int) # Paginación de los objectos a renderizar
...
def send_message():
	...
	if current_user.is_authenticated and form_email.validate_on_submit():
		...
		asyncio.run(send_email_admin(user, form_email.title.data, form_email.body.data))
